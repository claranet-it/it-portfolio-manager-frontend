...
export const SfIconStar = component$<{ onClick$?: QRL; variant?: 'dark' | 'light' }>(
	({ onClick$, variant = 'light' }) => {
		return (
			<svg
				xmlns='http://www.w3.org/2000/svg'
				viewBox='0 0 24 24'
				class={`skill-star inline-block h-6 w-6 ${variant === 'light' ? 'fill-clara-red-200' : 'fill-darkgray-200'}`}
