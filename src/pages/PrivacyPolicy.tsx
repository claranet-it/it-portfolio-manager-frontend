	...
	return (
		<div class='flex h-screen flex-col'>
			<header>
				<div class='items-center justify-between border-b border-b-darkgray-300 bg-white md:flex lg:flex'>
					...
					<div class='justify-end pr-6 sm:w-[100%] sm:text-center md:flex lg:flex'>
						<button
							class={`m-2 rounded border-0 bg-transparent p-2 font-semibold text-clara-red hover:text-red-500`}
							onClick$={() => {
			...
			<div class='w-full space-y-6 px-6 pb-16 pt-2.5'>
				<div>
					<h1 class='me-4 text-2xl font-bold text-darkgray-900'>{'Privacy Policy'}</h1>
					<p class='text-gray-500'>Last updated: January 24, 2025</p>
				</div>
				<div class='space-y-4 text-gray-600'>
					...
					<ul>
						...
						<li>
							<p>
								...
								this Agreement) refers to Claranet srl, Corso Europa 13 20122 Milan
								(Mi).
							</p>
						</li>
						<li>
						...
						<li>
							<p>
								<strong>Website</strong> refers to Brickly, accessible from
								<a
									href='https://app.brickly.me/'
									rel='external nofollow noopener'
									target='_blank'
								>
									https://app.brickly.me
								</a>
							</p>
						</li>
						<li>
					...
					<ul>
						<li>By email: info@brickly.me</li>
					</ul>
				</div>
			</div>
		</div>
